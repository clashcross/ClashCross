...
extern void start_log(long long int port);
extern void stop_log();
extern long int change_proxy(char* selector_name, char* proxy_name);
extern long int change_config_field(char* s);
extern void async_test_delay(char* proxy_name, char* url, long int timeout, long long int port);
