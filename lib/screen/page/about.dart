          ...
          children: [
            ...
            Wrap(
              children: [
                TextButton(
                    onPressed: () {
                      customLaunch(Uri.parse("https://github.com/Dreamacro/clash"));
                    },
                    child: Text(
                      "Clash".tr,
                    )),
                TextButton(
                    onPressed: () {
                      customLaunch(Uri.parse("https://github.com/flutter/flutter"));
                    },
                    child: Text("Flutter".tr,)),
                TextButton(
                    onPressed: () {
                      customLaunch(Uri.parse("https://github.com/Fclash/Fclash"));
                    },
                    child: Text("fclash".tr,)),
                TextButton(
                    onPressed: () {
                      customLaunch(Uri.parse("https://fonts.google.com/icons"));
                    },
                    child: Text("Material Icons".tr,)),
              ],
            ),
          ],
        ),
